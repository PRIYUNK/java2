...
public class task4{
	public static void main(String[] args) throws Exception {
		...
		Connection con= DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "database");
        ...
        case 1: 
        	System.out.println("Enter data of Student by following- regno, stdname, branch, mark");
    		int  regno= sc.nextInt();
    		String  stdname =  sc.next();
    		String  branch= sc.next();
    		float  mark  =sc.nextFloat();
    		
    		String qry= "insert into Student2  values("+ regno + " , '"+ stdname+ "', '"+branch+ "' , "+ mark+")";
        ...
        case 2:
    		...
    		String qry1="update Student2 set stdname='"+stdname1+"', branch='"+branch1+"', marks="+mark1+" where regdno="+regno1;                   
        ...
        case 3: 
    		...
    		while(rs.next())
    			...
    			System.out.println(rs.getInt("regno") + ", " + rs.getString("stdname")+ ", " +rs.getString("branch")+", "+rs.getFloat("mark"));
    		con.close();
        ...
        case 4:
        	...
        	String qry2 = "delete from Student2 where regdno = "+regno2;
